...
tags: ["query:av-pnc"]
score: 10.0
evidence: 面向自动驾驶车辆的终身轨迹规划，适应长尾场景
tldr: 自动驾驶车辆在开放世界中需持续适应罕见长尾场景同时保留已学驾驶技能，现有方法难以平衡稳定性与可塑性。本文提出NOMAD框架，结合非参数贝叶斯记忆与扩散轨迹生成，动态扩充场景表示并持续学习新专家，实现终身轨迹规划。实验表明该方法能有效应对复杂交通动态，避免灾难性遗忘，提升了自动驾驶在多变环境中的长期适应性和安全性。
source: ICML-2026-Accepted
selection_source: conference_retrieval
motivation: 现有轨迹规划方法无法稳健应对不断变化的复杂交通动态，存在稳定性-可塑性困境。
method: 提出NOMAD框架，整合非参数贝叶斯记忆与扩散轨迹生成，实现动态场景表示和持续学习。
result: 实验证明该方法能持续适应长尾场景而不遗忘已有技能，提升长期安全性。
conclusion: 为开放世界自动驾驶的终身学习提供了有效的轨迹规划方案。
---
