...
tags: ["query:av-pnc"]
score: 9.0
evidence: 自动驾驶车辆终身轨迹规划，基于扩散专家
tldr: 现有自动驾驶轨迹规划方法难以在开放世界中持续适应罕见长尾场景，同时保持已学驾驶技能。为此提出NOMAD框架，将非参数贝叶斯记忆与扩散式轨迹生成相结合，使车辆在面对不断演化的交通动态时能持续适应而不遗忘旧知识。在长期规划任务上，NOMAD相比静态模型和规则控制器显著提升了长尾场景鲁棒性和规划稳定性。该方法为自动驾驶系统的终身学习与安全规划提供了新思路。
source: ICML-2026-Accepted
selection_source: conference_retrieval
motivation: 现有轨迹规划方法在稳定性-可塑性权衡上表现不佳，难以应对开放世界的长尾场景和动态交通。
method: 提出NOMAD框架，融合非参数贝叶斯记忆与扩散式轨迹生成，持续适应长尾场景并避免灾难性遗忘。
result: 实验表明NOMAD在长期规划中相比现有方法显著提升了长尾场景适应能力和规划性能。
conclusion: NOMAD实现了自动驾驶轨迹规划的终身学习，为开放世界中的安全规划提供了有效方案。
---
