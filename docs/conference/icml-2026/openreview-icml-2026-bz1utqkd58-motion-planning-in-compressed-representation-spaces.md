...
tags: ["query:av-pnc"]
score: 10.0
evidence: 面向自动驾驶车辆运动规划的生成框架
tldr: 深度学习方法虽增强了运动规划能力，但基于搜索或优化的传统规划器仍不可或缺。本文提出一种生成框架，通过学习高压缩比的自编码器将运动规划问题映射到离散令牌的潜空间，统一深度学习先验与基于模型的规划。该框架可在压缩空间中进行高效搜索与优化，兼顾灵活性与效率。实验在自动驾驶车辆导航等任务上验证了其有效性，为复杂场景下的运动规划提供了新范式。
source: ICML-2026-Accepted
selection_source: conference_retrieval
motivation: 深度学习与基于模型的运动规划各有优势，需要统一框架结合两者。
method: 提出生成框架，用高压缩比自编码器学习离散令牌潜空间，统一深度学习与模型规划。
result: 在自动驾驶车辆导航等任务上验证了高效规划与灵活性。
conclusion: 为复杂场景下的运动规划提供了新的统一范式。
---
